...
namespace Decay.Tests
{
    public sealed class ArchitectureBoundaryTests
    {
        ...
        [Test]
        public void DecayExecutor_ExecuteDecay_IsInternalSoGameplayCannotBypassBattleFlow()
        {
            MethodInfo publicMethod = typeof(DecayExecutor).GetMethod(
                "ExecuteDecay",
                BindingFlags.Instance | BindingFlags.Public);
            MethodInfo internalMethod = typeof(DecayExecutor).GetMethod(
                "ExecuteDecay",
                BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        [Test]
        public void ScoreExecutor_ExecuteScore_IsInternalSoGameplayCannotBypassBattleFlow()
        {
            MethodInfo publicMethod = typeof(ScoreExecutor).GetMethod(
                "ExecuteScore",
                BindingFlags.Instance | BindingFlags.Public);
            MethodInfo internalMethod = typeof(ScoreExecutor).GetMethod(
                "ExecuteScore",
                BindingFlags.Instance | BindingFlags.NonPublic);
