...
namespace Decay.Tests
{
    public sealed class BattleBootstrapperTests
    {
        ...
        [Test]
        public void Create_AssemblesBattleInEnemySetupWithBothRostersTracked()
        {
            ...
            Assert.That(runtime.BattleState.CurrentPhase, Is.EqualTo(BattlePhase.EnemySetup));
        ...
        public void CreatedRuntime_UsesExistingMovementAuthorityRatherThanBootstrapMutationPath()
        {
            ...
            Assert.That(runtime.BattleController.CompleteEnemySetup().IsApproved, Is.True);
