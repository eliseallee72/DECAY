...
namespace Decay
{
    ...
    public sealed class BattleController
    {
        ...
        /// <summary>
        /// Completes round cleanup. A continuing game explicitly starts the next EnemySetup; otherwise GameEnd is
        ...
        public BattleFlowResult CompleteRoundEnd()
        {
            ...
            if (!gameEndRequired)
            {
                RequireApprovedTransition(BattlePhase.EnemySetup);
                return ApprovedFactsSince(firstFactIndex);
            }
        ...
        /// <summary>
        /// Completes GameEnd. If another configured game remains, BattleState advances to its EnemySetup. After the
