...
namespace Decay
{
    ...
    public sealed class DiceRuntimeSeed
    {
        ...
        private readonly ReadOnlyCollection<DiceFaceSeed> _facesView;
        private readonly ReadOnlyCollection<DiceTagId> _tagsView;
        ...
        public IReadOnlyList<DiceFaceSeed> Faces => _facesView;
        public IReadOnlyList<DiceTagId> Tags => _tagsView;
