...
namespace Decay
{
    public sealed class BattleInventoryState
    {
        ...
        private readonly List<DiceInstanceId> _trackedDiceIds = new List<DiceInstanceId>();
        ...
        private readonly ReadOnlyCollection<DiceInstanceId> _trackedDiceIdsView;
        ...
        public BattleInventoryState(int capacityPerSide, IEnumerable<DiceRuntimeState> dice)
        {
            ...
            _trackedDiceIdsView = _trackedDiceIds.AsReadOnly();
        ...
        /// <summary>
        /// Stable read-only battle roster identity in construction order. This is owned by
        /// BattleInventoryState and does not describe current Board/Inventory location.
        /// </summary>
        public IReadOnlyList<DiceInstanceId> TrackedDiceIds => _trackedDiceIdsView;
        ...
        private void AddInitialDice(DiceRuntimeState diceState)
        {
            ...
            _trackedDiceIds.Add(diceState.InstanceId);
